...
const CompanyProfilePage = lazy(() => import('./admin/CompanyProfilePage'));
        ...
        <div className="flex-1 flex flex-col">
          ...
          <main className="flex-1 p-6 overflow-auto">
            <Routes>
              ...
              <Route path="/company-profile" element={<Suspense fallback={<div className="p-6">Loading...</div>}><CompanyProfilePage /></Suspense>} />
