    ...
    <div className="py-12 px-4 md:px-8 lg:px-16 bg-background">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Collection</h2>
          ...
          <p className="bg-destructive/10 p-4 rounded-lg border border-destructive/20">
            <strong className="text-destructive">Important:</strong> If you receive an email, a call from a person/association claiming to be FEATHER FASHIONS seeking any personal data like debit/credit card PIN, net-banking or mobile banking password, we request you to never provide such information. If you have already revealed such information, report it immediately to an appropriate law enforcement agency.
          </p>
          
          <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Usage</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Sharing</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Security Precautions</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Data Deletion and Retention</h2>
