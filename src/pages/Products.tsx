...
const Products = () => {
  ...
  const products = [
    { name: "Cloud Whisper Lounge Set", category: "Women", fabric: "50% Modal, 50% Cotton", description: "Luxurious two-piece with wide-leg pants", image: product1 },
    ...
    { name: "DreamNest Pyjama Set", category: "Kids", fabric: "Soft Muslin", description: "Feather-patterned nightwear", image: product10 },
  ];
