...
const TermsAndConditions = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow py-12 px-4 md:px-8 lg:px-16 bg-background">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
            ...
            <p>
              This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://featherfashions.in/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
            </p>
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">Use of Platform and Services</h2>
